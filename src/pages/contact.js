  ...
  <Layout>
    ...
    <section className="site-content lg:px-0 px-6">
      <div className="container mx-auto">
          ...
          <h5 className="lg:text-2xl text-lg lg:text-justify text-center bg-blue-500 inline-block lg:p-6 p-3 text-gray-900"><span role="img" aria-label="code">👩‍💻</span> For work purpoese <span className="text-gray-900">wayoutworks@outlook.com</span></h5>
      </div>
    </section>
  </Layout>
)
